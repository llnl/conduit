...
* ``active_policy()``: returns an ``ExecutionPolicy`` corresponding to the memory space where the wrapper's data currently lives. This lets you execute wherever the input already resides:
