...
//-----------------------------------------------------------------------------
TEST(conduit_node_save_load, load_protocols_respect_each_other)
{
    ...
    // yaml schema has a,b,c
    n.save("tout_node_load_save_protocols_respect.conduit_bin", "conduit_bin_yaml");
    
    // test conduit_bin_yaml default when no json is present
    {
        Node n_load;
        n_load.load("tout_node_load_save_protocols_respect.conduit_bin");

        EXPECT_FALSE(n_load.has_path("path/to/d"));

        n_load.print_detailed();
    }

    // json schema has a,b,c,d
    n["path/to/d"] = 4;
    n.save("tout_node_load_save_protocols_respect.conduit_bin");

    // test conduit_bin_yaml
    {
        Node n_load;
        n_load.load("tout_node_load_save_protocols_respect.conduit_bin", "conduit_bin_yaml");
    ...
    {
        Node n_load;
        n_load.load("tout_node_load_save_protocols_respect.conduit_bin", "conduit_bin_json");
        EXPECT_TRUE(n_load.has_path("path/to/d"));

        n_load.print_detailed();
    }

    // test conduit_bin_json default
    {
        Node n_load;
        n_load.load("tout_node_load_save_protocols_respect.conduit_bin", "conduit_bin");
        EXPECT_TRUE(n_load.has_path("path/to/d"));
