...
TEST(conduit_blueprint_mesh_relay, spiral_multi_file)
{
    ...
    for(int nfiles=-1; nfiles < 9; nfiles++)
    {
        ...
        EXPECT_EQ(output_root, relay::io::blueprint::get_root_filename(data, output_base, "hdf5", opts));
...
TEST(conduit_blueprint_mesh_relay, save_read_mesh_opts)
{
    ...
    EXPECT_EQ(tout_root, relay::io::blueprint::get_root_filename(data, tout_base, "hdf5", opts));
    ...
    EXPECT_THROW(relay::io::blueprint::get_root_filename(data, tout_base, "hdf5", opts),Error);
...
TEST(conduit_blueprint_mesh_relay, save_multi_domain_json_yaml)
{
    ...
    EXPECT_EQ(tout_base + "json.root", relay::io::blueprint::get_root_filename(data, tout_base + "json", "json", opts));
    ...
    EXPECT_EQ(tout_base + "yaml.root", relay::io::blueprint::get_root_filename(data, tout_base + "yaml", "yaml", opts));
...
TEST(conduit_blueprint_mesh_relay, save_with_subdir)
{
    ...
    EXPECT_EQ(tout_file, relay::io::blueprint::get_root_filename(data, tout_base, "hdf5", opts));
...
TEST(conduit_blueprint_mesh_relay, round_trip_all_protos)
{
             ...
             itr < protocols.end(); ++itr)
    {
        ...
        opts["suffix"] = "none";
        EXPECT_EQ(tout_fname, relay::io::blueprint::get_root_filename(data, tout_base, protocol, opts));
...
TEST(conduit_blueprint_mesh_relay, sparse_topos)
{
    ...
    EXPECT_EQ(tout_hdf5_root, relay::io::blueprint::get_root_filename(data, tout_base + "_hdf5", "hdf5", opts));
    EXPECT_EQ(tout_yaml_root, relay::io::blueprint::get_root_filename(data, tout_base + "_yaml", "yaml", opts));
...
TEST(conduit_blueprint_mesh_relay, spiral_multi_file_yaml_json_hdf5_silo)
{
    ...
    for(auto protocol : protocols)
    {
        ...
        EXPECT_EQ(output_root, relay::io::blueprint::get_root_filename(data, output_base, protocol));
