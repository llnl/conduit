...
//-----------------------------------------------------------------------------
template void conduit::detail::set_value_forall_device_helper(const conduit::DataAccessor<conduit::uint32> &accessor, conduit::index_t idx, conduit::uint32 value);
