...
struct formatter<Tuple, Char,
                 enable_if_t<conduit_fmt::is_tuple_like<Tuple>::value &&
                             conduit_fmt::is_tuple_formattable<Tuple, Char>::value>> {
 private:
 ...
 *     conduit_fmt::print("{}", conduit_fmt::join(v, ", "));
 *     // Output: 1, 2, 3
 *
 * `conduit_fmt::join` applies passed format specifiers to the range elements:
 *
 *     conduit_fmt::print("{:02}", conduit_fmt::join(v, ", "));
 *     // Output: 01, 02, 03
 */
 ...
 *     conduit_fmt::print("{}", conduit_fmt::join(t, ", "));
 *     // Output: 1, a
 */
 ...
 * **Example**:
 *
 *     conduit_fmt::print("{}", conduit_fmt::join({1, 2, 3}, ", "));
 *     // Output: "1, 2, 3"
 */
template <typename T>
