...
inline auto make_printf_args(T&... args)
    -> decltype(conduit_fmt::make_format_args<basic_printf_context<Char>>(args...)) {
  return conduit_fmt::make_format_args<basic_printf_context<Char>>(args...);
}
 ...
 * **Example**:
 *
 *     std::string message = conduit_fmt::sprintf("The answer is %d", 42);
 */
template <typename... T>
 ...
 * **Example**:
 *
 *     conduit_fmt::fprintf(stderr, "Don't %s!", "panic");
 */
template <typename... T>
 ...
 * **Example**:
 *
 *   conduit_fmt::printf("Elapsed time: %.2f seconds", 1.23);
 */
template <typename... T>
